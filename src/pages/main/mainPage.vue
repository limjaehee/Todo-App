      ...
      <div class="c-inner">
        <div class="m-banner__wrapper">
          ...
          <div>
            ...
            <p class="m-banner__complete">
              <span class="m-banner__complete__num">{{
                CompletedLength()
              }}</span>
              complete
            </p>
        ...
        <template v-slot="{ item, index }">
          <div class="m-task__item">
            ...
            <div class="m-task__item__txtbox">
              ...
              <span class="m-task__item__description">{{
                item.description
              }}</span>
            </div>
          ...
          <template #cont>
            <div class="task-popup__cont">
              <div class="c-input" :class="`${isCheck.title ? 'clear' : ''}`">
                ...
                />
                <label for="sampleId" class="c-input__title"
                  >Enter your task</label
                >
              </div>
              <div
                class="c-input"
                :class="`${isCheck.description ? 'clear' : ''}`"
              >
                <input
                  type="text"
                  class="c-input__input"
  ...
  methods: {
    ...
    BtnEvt() {
      ...
      if (this.settingOn == false && !title == "") {
        ...
        this.OngoingList[this.settingIndex].time = `${
...
.m-add-btn {
  ...
  background: linear-gradient(
    225deg,
    rgba(124, 120, 229, 1) 0%,
    rgba(176, 130, 236, 1) 100%
  );
  border-radius: 10px;
  color: #fff;
  font-size: 18px;
